...
// Provide a mock DOMMatrix to fix pdf-parse / pdf.js errors in Next.js Server environments
if (typeof process !== "undefined" && typeof globalThis.DOMMatrix === "undefined") {
    class DOMMatrix {
