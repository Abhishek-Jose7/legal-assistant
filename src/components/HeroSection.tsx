  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div
          className="z-10 flex flex-col items-center px-4 text-center max-w-4xl"
          style={{ opacity, y }}
        >
          {/* Badge */}
          <motion.div
            ...
            className="mb-6 px-4 py-1.5 rounded-full border border-[#C8AD7F]/30 bg-[#F5EEDC]/10 backdrop-blur-md"
          >
            <span className="text-sm font-medium text-[#F5EEDC] tracking-wide uppercase">AI-Powered Legal Clarity</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold tracking-tight mb-6 text-[#F5EEDC] drop-shadow-xl"
          >
            <motion.span
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
